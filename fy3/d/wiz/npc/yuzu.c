...
string *msg_d = ({
                      ...
                      "操！","操!","fuck","FUCK","Fuck","婊子","有没有活的","想死?",
                      "你奶奶的","和你妈做爱","她妈的","你爷爷的","有没有喘气的","放你妈的屁","tmd","TMD","tmmd","TMMD","操你妈","日死你","干你娘","没死回？",
     "操你姐","狗屁","日死爸","Nnd","干你妈","干你的","去你妈","你卵",
"ｆ ｕ ｃ ｋ","Ｆ Ｕ Ｃ Ｋ","F  u  c  k","f  u  c  k","n n d","N N D","S B",
"ｆｕｃｋ","ＦＵＣＫ","F u c k","f u c k","nnd","NND","SB","鸡吧","鸡八","傻b",
                      "mlgb","MLGB","mcb","MCB","蛋子","你妈","你爹","牛比","妈比","放屁","吃屎","你大爷",
"操你妈","打炮","日你妈","大便","小便","caobi","手淫",});
            ...
            if( strsrch(msg, msg_d[i]) >= 0)
                   {
                    ...
                    message("channel:rumor",HIM"【谣言惑众】某人：据说 "HIR+criname+HIM" 在公众频道使用粗言烂语，被巡查使抓走了。\n"NOR, users());
                    return;
                    }
        }
}
