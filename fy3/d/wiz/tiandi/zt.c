...
//      ob1->move(ob);
        ...
        obj1->set("combat_exp", random(10000000)+5*((int)me->query("combat_exp")));
        obj1->add_temp("apply/armor",random(1000)+((int)me->query("combat_exp"))/2000);
        obj1->add_temp("apply/iron-cloth", random(1000)+((int)me->query("combat_exp"))/2000);
...
int do_finish (string arg)
{
        ...
        int kf_whatnpc,kf_exp,kf_qn,gold_num,reb;
        object me = this_player();
        ...
        gold_num = kf_whatnpc*10+random(20);
