...
{
		int *coor;
		if((coor=environment(this_player())->query("coor/x"))==0)coor=0;
                if((coor=environment(this_player())->query("coor/y"))==0)coor=0;
                if((coor=environment(this_player())->query("coor/z"))==0)coor=0;
