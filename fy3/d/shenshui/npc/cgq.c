...
void create()
{
	...
	set("int",20);
       set("attitude","friendly");
        ...
        set("chat_msg_combat", ({(: perform_action, "blade.bafangfengyu" :),
...
set("chat_msg", ({
                "开叶说道：上天入地，十九人魔。\n",
                "开叶说道：帮主神出鬼没，我也不知道他的行踪。\n",
        }) );

    setup();

             carry_object("/obj/glass");
carry_object("/d/fy/npc/obj/blade")->wield();
}
