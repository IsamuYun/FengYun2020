        ...
        if (me->query("kill_qiangdao") == 1) {
                ...
                switch(random(4)) {
                        case 0 :
                                ...
                                command("tell " + me->query("id") + " 有一个强盗在扬州城东为非作歹，你去降服他。");                           
                                break;
                        case 1 :
                                place = yz_south[random(sizeof(yz_south))];
                                ob->move(place);
                                me->set("quest/place", place);
                                command("tell " + me->query("id") + " 有一个强盗在扬州城南为非作歹，你去降服他。");                           
                                break;
                        case 2 :
                                place = yz_north[random(sizeof(yz_north))];
                                ob->move(place);
                                me->set("quest/place", place);
                                command("tell " + me->query("id") + " 有一个强盗在扬州城北为非作歹，你去降服他。");                           
                                break;
                        default :
                                ...
                                me->set("quest/place", place);
                                command("tell " + me->query("id") + " 有一个强盗在扬州城西为非作歹，你去降服他。");                           
                }               
