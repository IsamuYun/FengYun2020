...
{
	set_name("王妃", ({"fei"}));
	set("nickname", HIM "娇媚如月" NOR);
	set("long", HIC "\n她长得极美，尤其是那双眼睛，媚得直可以勾人魂魄。\n"+
	"其容色晶莹如玉，映照于红红烛光之下，娇美不可方物。\n"+
	"回眸嫣然一笑，雅如仙子下凡。眼波流转之间，\n"+
	"便把一个少年的心灵，推向梦中极美的境界。\n" NOR);
	set("title", HIC "女性之花" NOR);
	set("gender", "女性");
	set("age", 21);
	set("rank_info/respect", "王妃");
	set("max_kee", 10000);
	set("max_gin", 10000);
	set("force", 5000);
	set("max_force", 5000);
...
set("con", 50);
	...
	set("chat_msg", ({
		...
		(: command("laughproud") :),
		"王妃忽然大声说：打倒臭泥潭，打倒风云！\n",
		"王妃无聊地绕着手绢，叹道: 唉，一个人，真没意思。\n",
		"王妃伸出白玉雕成一般的小手，托着下巴说: 谁想和我说说话?\n",
		"王妃斩钉截铁地说: 嗯，谁要敢欺负我，我就宰了他！\n",
		"王妃忽然莞尔一笑道: 皇上待会儿又要对我怎么呢？\n",
		"王妃打了个呵欠，左手轻轻掩住樱桃小口，柔声道：我困了。\n",
		(: drool :),
		(: drool :),
		(: command("reclaim") :),
		(: command("reclaim") :),
	...
	setup();
	carry_object("/obj/ring")->wear();
	carry_object("/obj/crystal")->wear();
	carry_object("/obj/shouzhuo")->wear();
	carry_object("/obj/majia")->wear();
	carry_object("/obj/baojia")->wear();
	carry_object("/obj/bishou")->wield();
	carry_object("/obj/yupei")->wear();
	carry_object("/obj/hlbian")->wield();
	carry_object("/obj/gun")->wield();
...
void relay_emote(object ob, string verb)
{
	...
	{
	command ("chat 皇上快来啊，"+ ob->query("name") + "想要非礼我！\n") ;
	command("chat 哎哟，谁想得到这" + RANK_D->query_rude(ob)+"，竟也是一个好色之徒 。");
	}
	else
	{
	message_vision("\n王妃对$N笑道：“你我同为女儿身，再怎么喜欢也不要这样啊。”\n", ob);
	command("giggle");
   ...
   switch(random(50))
   {
    ...
    case 8:
    command("cry");
   command ("chat 皇上快来啊，"+ ob->query("name") + "想要羞辱我！\n") ;
...
varargs void drool(string msg, string who)
{
	...
	case 7:	this_object()->set("killer","王妃");break;
	...
	if( (strsrch(msg, "liling") >= 0)||(strsrch(msg, "王妃") >= 0))
	{	
	...
	{	
		...
		case 3:	command("chat* 王妃点了点头.\n");	break;
		case 4:command("chat* 王妃嚎啕大哭起来.\n"); break;
		case 5:command("chat* 王妃揉了揉哭红的眼睛，跺脚道： "+who+",你真要走了就别再回来！\n"); break;
		case 6:	command("chat* 王妃深深地叹了一口气 。\n");	break;
	...
	if( (strsrch(msg, "kiss") >= 0)|| (strsrch(msg, "love") >= 0)|| (strsrch(msg, "吻") >= 0)
		...
		case 3:command("chat* 王妃被"+who+"气得晕了过去。\n"); break;
		case 4:command("chat* 王妃嚎啕大哭起来.\n"); break;
		case 5:command("chat 不要这样子嘛！\n"); break;
		case 6:command("chat 非礼啊非礼！"+who+"这小流氓又来啦！\n"); break;
		case 7:command ("chat 皇上快来啊，"+ who + "想要羞辱我！\n") ;
		case 8:	command("chat* 王妃嘻嘻地笑了几声.\n"); break;
		case 9:	command("chat* 王妃很生气地撅了撅嘴。\n");	break;
		case 10:command("chat* 王妃无奈的耸了耸肩.\n");	break;
		case 11:command("chat 你对女孩子总是这样吗？\n"); break;
		case 12:command("chat 大哥你怎么这样？\n"); break;
		case 13:command("chat* 王妃嫣然一笑，说：够了够了!\n"); break;
		case 14:command("chat* 王妃满脸胀得通红，急道：你。。。 。\n");	break;
		case 15:command("chat 嗯，"+who+"是天底下最好的人了！\n"); break;
	                case 16:command ("chat 皇上快来啊，"+ who + "欺负我！\n") ; break;
		}
		return;
	}
	...
	{	
		...
		case 3:	command("chat* 王妃很生气地撅了撅嘴。\n");	break;
		...
		case 9:	command("chat* 王妃鄙夷地看着"+who+",恨不得"+who+"去死。\n"); break;
		case 10:command("chat* 王妃被"+who+"气得晕了过去。\n"); break;
		case 11:command("chat* 王妃忽然大声说：打倒臭泥潭，打倒风！\n"); break;
		case 12:command("chat* 王妃揉了揉哭红的眼睛，跺脚道： "+who+",我恨死你了！\n"); break;
		case 13:command ("chat 皇上快来啊，"+ who + "又想要羞辱我！\n") ; break;
		}
	}
	...
	{	
		...
		case 3:	command("chat* 王妃用手捂住鼻子，说“"+who+"说话好臭!\n");	break;
		case 4:	command("chat 你真的认为“" + msg + "”？\n"); break;
		case 5:	command("chat 我觉得你有点儿缠杂不清。\n"); break;
		case 6: command("chat 呸!\n"); break;
		case 7:	command("chat* 王妃怒道:你怎么知道“" + msg + "”？\n"); break;
		case 8:	command("chat "+ who+"滚出来!我要和你决斗！有胆子你就放马过来！\n"); break;
		case 9:	command("chat* 王妃鄙夷地看着"+who+",恨不得"+who+"去死。\n"); break;
		case 10:command("chat* 王妃嚎啕大哭起来.\n"); break;
		case 11:command("chat* 王妃揉了揉哭红的眼睛，跺脚道： "+who+"王八蛋给我滚出去！\n"); break;
	...
	{	
		...
		case 3:	command("chat* 王妃嫣然一笑，说：够了!\n"); break;
		case 4:	command("chat 你真的认为“" + msg + "”？\n"); break;
		case 5: command("chat* 王妃忽然莞尔一笑道: 你这是不是有点儿。。。？\n");break;
		case 6:    command("chat* 王妃回头看了"+who+"一眼，没吭声。\n");break;
		case 7: command("chat 嗯,"+who+"是一个好孩子.\n"); break;
		case 8:command("chat "+who+",你不会是想讨好我吧?\n"); break;
		case 9:command("chat* 王妃拱了拱手道：过奖，过奖 !\n");break;
		case 10:command("chat* 王妃指着"+who+"赞叹道：“"+who+"是武林第一高手！”\n");break;
		case 11:command("chat* 一朵红云飞上了王妃的面颊.\n");break;
		}
		return;
        }
	}
	switch(random(80)) {
		...
		case 12:	command("chat* 王妃深深地叹了一口气 。\n");	break;
		case 13:	command("chat* 王妃被"+who+"气得晕了过去 。\n");	break;
		case 14:	command("chat* 王妃满脸胀得通红，急道：你。。。 。\n");	break;
		case 15:    command("chat* 王妃咬了咬牙，怒道: 嗯，谁要再敢欺负我，我就宰了他！\n");break;
		case 16:    command("chat* 王妃忽然莞尔一笑道: 你这又是何苦呢？\n");break;
		case 17:    command("chat* 王妃打了个呵欠，左手轻轻掩住樱桃小口，柔声道：我困了。\n"); break;
		case 18:    command("chat* 王妃回头看了"+who+"一眼，没吭声。\n");break;
		case 19:    command("chat* 王妃一甩头，说：哼，我都懒得理你。\n");break;
		...
		case 24:	command("chat* 王妃嫣然一笑，说：够了!\n"); break;
		case 25:	command("chat 居然有人骂我是猪!\n");
		 	command("chat* 王妃嚎啕大哭起来.\n"); break;
        case 26:	command ("chat 皇上快来啊，"+ who + "又来欺侮我！\n") ; break;
      	case 27:	command ("chat 我简直受不了了!\n") ; break;
        case 28:	command ("chat 我恨不得"+who+"去死!\n") ; break;
        case 29:	command ("chat 就你老和我过不去!\n") ; break;
        case 30:	command ("chat 请不要打扰我好不好?\n") ; break;
   		case 31:	command ("chat* 王妃终于忍不住哭了起来。\n") ; break;
		case 32:	command("chat* 王妃鄙夷地看着"+who+",恨不得"+who+"去死。\n"); break;
		case 33:    command("chat* 王妃咬了咬牙，怒道: 嗯，谁要敢欺负我，我就宰了他！\n");break;
		case 34:    command("chat* 王妃忽然莞尔一笑道: 你这是不是有点儿。。。？\n");break;
		case 35:    command("chat* 王妃打了个呵欠，左手轻轻掩住樱桃小口，柔声道：我有点儿困了。\n"); break;
		case 36:    command("chat* 王妃回头看了"+who+"一眼，没吭声。\n");break;
		case 37:    command("chat* 王妃一甩头，说：哼，我都懒得理你。\n");break;
		...
		case 54:command("chat* 王妃对"+who+"表示衷心的感谢.\n");break;
		case 55:command("chat 不要这样子嘛！\n"); break;
		case 56:command("chat* 王妃拱了拱手道：过奖，过奖 !\n");break;
		case 57:command("chat* 王妃怒道:你怎么知道“" + msg + "”？\n"); break;
		case 58:command("chat* 王妃指着"+who+"赞叹道：“"+who+"是武林第一高手！”\n");break;
		case 59:command("chat* 王妃笑嘻嘻的看着"+who+"\n");break;
		case 60:command("chat 为什么呢?\n");break;
		case 61:command("chat 你是在说我吗？\n"); break;
		case 62:command("chat 无聊!\n");break;
		case 63:command("chat* 一朵红云飞上了王妃的面颊.\n");break;
		case 64:command("chat* 王妃是个自恋狂。\n");break;
		default:
	    if (random(10)<3) command("chat* 王妃很生气地撅了撅嘴.\n"); 
	    else if(random(10)<3) command("chat* 王妃嘻嘻地笑了几声.\n");
	    break; 
		}
	return;
	} 
	...
	{	
	   if(random(5)<3)
		...
		case 2:	command("chat* 王妃嘻嘻的笑了几声.\n"); break;
		case 3:command("chat* 王妃露出迷惑的表情.\n"); break;
		case 4:command("chat* 王妃嚎啕大哭起来.\n"); break;
		case 5:command("chat* 王妃安慰"+who+",别难过了.\n"); break;
		case 6:	command("chat* 王妃深深地叹了一口气 。\n");	break;
		case 7:	command("chat* 王妃无奈的耸了耸肩.\n");	break;
		case 8: command("chat* 王妃轻轻拍了拍"+who+"的头.\n"); break;
		}
		return;
        }
	}
	...
	{	
		...
		case 11:	command("chat* 王妃嘻嘻的笑了几声.\n"); break;
		case 12:	command("chat* 王妃把把头摇得跟拨浪鼓似的.\n");	break;
		case 13:	command("chat* 王妃哈哈大笑起来.\n"); break;
		}
		return ;
        }
	} 
		...
		case 12: command("chat* 王妃轻轻拍了拍"+who+"的头.\n"); break;
	...
	{	
		...
		case 3:	command("chat "+who+"笑起来真丑。\n"); 
			if(random(10)<2) command("chat* 王妃嘻嘻地笑了几声.\n");break;
		case 4:	command("chat* 王妃咯咯地笑了起来.\n");break;
		case 5:	command("chat* 王妃高兴地拍了拍手.\n");break;
		case 6: command("chat* 王妃轻轻拍了拍"+who+"的头.\n"); break;
		case 7:	command("chat* 王妃哈哈大笑起来.\n"); break;
		case 8: command("chat* 王妃说道:同喜,同喜!!!\n" );break;
		...
		case 11:drool(); break;
		case 12:drool(); break;
		case 13:command("chat* 王妃嘻嘻地笑了几声.\n"); break;
		case 14:command("chat* 王妃摇了摇头，叹道：唉，真是世风日下，人心不古啊！\n"); break;
		case 15:command("chat 我对此表示怀疑.\n"); break;
		case 16:command("chat* 王妃深深地叹了一口气 。\n");	break;
		case 17:command("chat* 王妃露出迷惑的表情.\n"); break;
		...
		switch(random(250)) {
			...
			case 2: command("chat* 王妃「哼」地冷笑一声。\n"); break;
			case 3: command("chat* 王妃懒懒地伸了伸腰。\n"); break;
			case 4: command("chat* 王妃气得晕了过去.\n"); break;
			case 5: command("chat  哼！\n"); break;
			case 6: command("chat* 王妃露出迷惑的表情.\n"); break;
			case 7: command("chat* 王妃忽然作了个鬼脸,说：真想出去玩会儿.\n"); break;
			...
			case 11: command("chat* 王妃很生气地噘了噘嘴。\n"); break;
			...
			case 18: command("chat* 王妃摇头叹道：这世道，还是各人自扫门前雪，休管他人瓦上霜.\n");break;
			case 19: command("chat* 王妃作了一个揖，说道：“各位姐妹们，大家好！”\n");break;	
			case 20: command("chat 我知道了，" + msg+"\n"); break;
			case 21:command("chat* 王妃露出迷惑的表情.\n"); break;
			...
			case 25: command("chat* 王妃无聊地绕着手绢，说：一个人，真没意思。\n"); break;
			case 26: command("chat* 王妃露出迷惑的表情.\n"); break;
			case 27: command("chat* 王妃用怀疑的眼光看了看"+who+"\n"); break;
			case 28: command("chat  我看未必.\n"); break;
			case 29: command("chat* 王妃奇道：是吗？\n"); break;
			case 30: command("chat  老师来啦，"+who+"你还不赶快去？\n"); break;
			case 31: command("chat "+who+",你今天怎么又逃课?\n"); break;
			case 32: command("chat* 王妃对所有在场的人表示感谢。\n"); break;
			case 33: command("chat* 王妃嘻嘻地笑了几声.\n");break;
			case 34: command("chat "+who+"说得好!\n"); break;
			case 35: command("chat* 王妃好奇地看着"+who+"\n"); break;
			case 36: command("chat "+who+",没想到你也会这样.\n"); break;
			case 37: command("chat* 王妃白了"+who+"一眼,说:你无聊不无聊啊?"); break;
			case 38:  command("chat* 王妃回头看了"+who+"一眼，没吭声。\n");break;
			case 39:command("chat* 王妃摇了摇头，叹道：唉，真是世风日下，人心不古啊！\n"); break;
			case 40:command("chat 嗯 ... " + who + "说得好！\n"); break;
			case 41:command("chat* 王妃无奈的耸了耸肩.\n");	break;
			case 42:command("chat 嗯，"+who+"是天底下最好的人了！\n"); break;
			case 43:command("chat* 王妃把把头摇得跟拨浪鼓似的.\n");	break;
			case 44:command("chat 我对此表示怀疑.\n"); break;
			case 45: command("chat 我觉得最佳表情奖应该授予"+who+".\n"); break;
			case 46: command("chat* 王妃轻轻拍了拍"+who+"的头.\n"); break;
			case 47: command("chat* 王妃笑嘻嘻的看着"+who+"\n"); break;
			...
			case 55: command("chat* 王妃打了"+who+"一个耳光.\n"); break;
			case 56:command("chat* 王妃给大家盈盈的福了一福.\n"); break; 
			case 57:command("chat 不要这样嘛!\n"); break;
			case 58:command("chat 要死啊你!"+who+"!\n"); break; 
			case 59:command("chat* 王妃忽然大声说：打倒臭泥潭，打倒风！\n"); break;
			case 60:command("chat* 王妃露出迷惑的表情.\n"); break;
			case 61:command("chat* 王妃振臂高呼：“我们热爱侠客行，侠客行万岁！”\n");break;
			case 62:command("chat* 王妃对大家摇摇头，叹道：“你们都太不要脸了。”\n");break;
			case 63:command("chat* 王妃点了点头.\n");	break;
			case 64:command("chat* 王妃哈哈大笑起来.\n"); break;
			case 65: command("chat 与其求人,不如求己!\n"); break;
			case 66:command("chat* 王妃失望极了!\n");break;
			case 67:command("chat 无聊!\n");break;
			case 68:command("chat 是吗?\n"); break;
		        case 69:command("chat 变态！\n"); break;
			case 70:command("chat* 王妃是个自恋狂。\n");break;
			case 71:command("chat 为什么？\n");break;
			case 72:command("chat 你烦不烦啊？\n");break;
			default:
	    if (random(10)<1) command("chat* 王妃皱了皱眉，似乎想说什么。\n");
		else if (random(10)<1) command("chat* 王妃嘻嘻地笑了几声.\n");
	    else if (random(10)<1) command("chat* 王妃懒懒的伸了伸腰.\n");
				break;
		}
	}
}
...
int do_tell ( string arg )
{
   ...
   if( arg=="liling" ) {
   message_vision("\n王妃对$N笑道：“你发痴啊，居然跟机器人说话。”\n", ob);
   command("say 想不到"+ob->query("name")+"这" + RANK_D->query_rude(ob)+"，竟然是一个变态！");
   command("tell "+ob->query("id")+" 你真逗。");
   return 1;
   }
   if( sscanf(arg, "liling huangdi send me %s", dir2)==1 ) {
	ob->set_temp("huangdinod2",1);
	command("xixi");
	return 1;
   }
   if( sscanf(arg, "liling %s", dir)==1 ) {
		...
		{
		command("tell "+ob->query("id")+" 你尽管自个儿爱吧。");
...
int do_chat( string arg )
{
   ...
   if( sscanf(arg, "*kiss %s", dir)==1 ) {
		if( dir=="liling") {
		if(ob->query("id")=="huangdi") return 0;
		else
		{
...
int do_sing ( string arg )
{
   ...
   if( sscanf(arg, "for %s", dir)==1 ) {
		...
		case 1:
		message_vision(	"$N对$n嫣然一笑.\n\n",this_object(),ob );
		ob->set_temp("huangdinod",1);
		break;
		default:
		message_vision("\n王妃对$N笑道：“你发花痴啊，居然对机器人唱歌。”\n", ob);
...
int accept_object(object me, object ob)
{
	...
	{
 	        if(me->query_temp("huangdinod"))
		{
		tell_object(me, "\n王妃嫣然一笑，说：好吧，既然皇上叫你来，那我就听你的。\n");
		tell_object(me, "请键入：杀 目标中文名字\n");
		me->delete_temp("huangdinod");
		me->set_temp("fee_paid",1);
		return 1;
		}
		else 
		{
		say("\n王妃摇摇头，笑道：不好吧，杀人的事皇上不会同意的。\n");
		me->set_temp("fee_paid2",1);
		tell_object(me, "\n王妃嫣然一笑，说：不过，我可以开个小玩笑。\n");
	...
	{
	message_vision("\n$N猛的扬起头，用惊喜的眼光看着$n，说：\n"
	+"咦，这不是皇上送我的戒指吗，是他要你带来的么? 真谢谢你啊...\n",this_object(),me);
	}
	if ((string)ob->query("name")==HIW "水晶鞋" NOR) 
	{
	message_vision("\n$N猛的扬起头，用惊喜的眼光看着$n，说：\n"
	+"咦，这不是皇上送我的吗水晶鞋吗，是他要你带来的么? 真谢谢你啊...\n",this_object(),me);
	}
	...
	{
	message_vision("\n$N缓缓地摇了摇头，柔声说道:不是皇上送我的,我不要.\n"
	+"说罢垂下头来，咬了咬牙,幽幽嗔道：死皇上，郴噬嚣，为什么还不回来呢?\n",this_object());
	return 0;
	}
}
...
int do_name(string target)
{
	...
	if(me->query("waiting_target"))
		return notify_fail("王妃：我现在正忙着哪，您呆会儿再来吧！\n");
	if( !this_player()->query_temp("fee_paid") ) 
		return notify_fail("王妃打了个呵欠，左手轻轻掩住樱桃小口，柔声道：\n"+
		"不好吧，帮你杀了人我又有什么好处呢？\n");
	if( !target || target==" ")
		return notify_fail("王妃打了个呵欠，左手轻轻掩住樱桃小口，柔声道：\n"
		+"请告诉我那人的名字，我可没功夫跟你闲聊。\n");
	...
	if( !dest )
		return notify_fail("王妃做了个鬼脸：不太好啊，好像他不在喔。\n");

	if (dest->is_ghost())
		return notify_fail("王妃说：你黑，你太黑，你太太黑，你太太太黑！他已经死啦！\n");
	me->set("waiting_target", dest->query("id"));
	me->set("target_name", target);
	me->delete("chat_chance");
	me->delete("chat_msg");
	message("vision",
	HIY "\n王妃正要离开，忽又回首道：你别走，就在这儿静侯佳音吧。\n" NOR,
	environment(), me );
	me->set("pursuer", 1);
...
int do_name2(string target)
{
	...
	if(!this_player()->query_temp("fee_paid2") ) 
		return notify_fail("王妃打了个呵欠，左手轻轻掩住樱桃小口，柔声道：\n"+
		"不好吧，那样做我又有什么好处呢？\n");
        if(!this_player()->query_temp("huangdinod2"))
		return notify_fail("\n王妃摇摇头，笑道：不好吧，打人的事皇上不会同意的。\n");
        if( !target || target==" ")
		return notify_fail("王妃打了个呵欠，左手轻轻掩住樱桃小口，柔声道：\n"
		+"请告诉我那人的名字，我可没功夫跟你闲聊。\n");
	for(i=0; i<sizeof(all); i++)
	...
	if( !dest )
		return notify_fail("王妃做了个鬼脸：不太好啊，好像他不在喔。\n");
	if (dest->is_ghost())
		return notify_fail("王妃说：你好坏哟，他已经死啦！\n");
	me->set("waiting_target2", dest->query("id"));
        this_player()->delete_temp("huangdinod2");
        this_player()->delete_temp("fee_paid2");
	message("vision",
		HIM "\n王妃以袖掩口，笑道：嘻嘻，好像成了耶，你怎么谢我呀？\n" NOR,
		environment());
...
int do_faint(object me)
{
	...
	message_vision(HIC "$N对$n说道：有人请我来打晕你，对不起啊。。。\n"
        ...
        dest->unconcious();
	this_object()->move("/u/huangdi/workroom");
 	return 1;
}
...
int do_kill(object me, object dest)
{
	...
	{
		message_vision(HIR "$N对$n说道：皇上要我来杀你，对不起啊。。。\n"
			+RANK_D->query_rude(dest)+"，你就认命吧！\n" NOR, me, dest);
			if(wizardp(dest))		
	                { 
			dest->set("immortal",0);
...
int do_back(object me)
{
	...
	me->move("/u/huangdi/workroom");
	message("vision", "王妃走了进来，幽幽道：唉，皇上真不乖，害得我又杀了人。\n", 
		environment(), me );
	me->set_leader(0);
	set("chat_chance", 3);
	set("chat_msg", ({
