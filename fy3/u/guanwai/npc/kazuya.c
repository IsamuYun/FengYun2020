...
void create()
{
	...
	set("int",20);
       set("attitude","friendly");
        ...
        set("chat_msg_combat", ({(: perform_action, "dagger.pingshuixiangfeng" :),
