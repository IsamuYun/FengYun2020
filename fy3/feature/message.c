...
string prompt()
{
   ...
   switch (prompt)
        ...
        case "time":
                ...
                break;
        case "date":
                p = HIC+ "/cmds/usr/ctime"->chinese_time(8,(string)localtime(time()))+ p;
                break;
        case "mud":
                p = HIC + NATURE_D->game_time() + p;
                break;
        case "sen":
                p = HIG + sprintf("sen : %d", query("sen")) + p;
                break;
         case "gin":
                p = HIG + sprintf("gin : %d", query("gin")) + p;
                break;
        case "kee":
                p = HIG + sprintf("kee : %d", query("kee")) + p;
                break;
        case "exp":
                p = HIG + sprintf("exp : %d", query("combat_exp")) + p;
                break;
        case "pot":
                p = HIG + sprintf("pot : %d", query("potential")) + p;
                break;
        case "hp":
                p = HIG + sprintf("%d/%d/%d", query("gin"), query("kee"), query("sen")) + p;
                break;
       case "path":
