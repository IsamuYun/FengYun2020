...
private void get_gender(string gender, object ob, object user)
{
	...
	write("
		...
		5£®²Ø×å       £¨ÄÍÁ¦ĞÍ£©
		\n");
	write("ÇëÑ¡ÔñÄãÔÚ·çÔÆ¢óÖĞµÄÃñ×å£¨0£¬1£¬2£¬3£¬4£¬5£©£º");
	input_to("get_nresp",ob, user);
}
private void get_nresp(string arg, object ob, object user)
{
        if( arg=="" ) {
                write("ÇëÑ¡ÔñÄãÔÚ¿ìÀÖÔÆÖĞµÄÃñ×å£¨0£¬1£¬2£¬3£¬4£¬5£©£º");
                input_to("get_nresp", ob, user);
                return;
        }
...
user->query("id"),
	...
	return;
                ...
                write("¶Ô²»Æğ£¬ÄúÖ»ÄÜ´Ó£¨0,1,2,3,4,5£©ÖĞÑ¡Ôñ£º ");
                input_to("get_nresp", ob,user);
                return;
        }
