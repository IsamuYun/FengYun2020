...
void ready_to_start()
{
       ...
       call_out("start_story", 3600 + random(30));//间隔时间
//        call_out("start_story", 10 + random(1));//间隔时间
}
