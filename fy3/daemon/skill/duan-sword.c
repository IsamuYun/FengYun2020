...
mapping *action = ({
        ([      "action":               
"$N使一招「灵蛇出洞」，手中$w如一条银蛇般刺向$n的$l",
                "dodge":                -20,
                "damage":               30,
                "damage_type":  "刺伤"
        ]),
        ([      "action":               
"$N使出段氏剑法中的「空山鸟语」，剑光霍霍斩向$n的$l",
                "dodge":                -20,
                "damage":               30,
                "damage_type":  "割伤"
        ]),
...
"$N一招「御风而行」，身形陡然滑出数尺，手中$w斩向$n的$l",
        ...
        ([      "action":               
"$N手中$w中宫直进，一式「山茶吐蕊」对准$n的$l刺出一剑",
                "dodge":                -40,
                "damage_type":  "刺伤"
        ]),
        ([      "action":               
"$N纵身一跃，手中$w一招「阳光普照」对准$n的$l斜斜刺出一剑",
                "dodge":                -40,
                "damage_type":  "刺伤"
        ]),
        ([      "action":               
"$N的$w凭空一指，一招「百鸟朝凤」刺向$n的$l",
                "dodge":                20,
                "damage":               40,
                "damage_type":  "刺伤"
        ]),
...
int valid_learn(object me)
{
        ...
        if( (int)me->query("max_force") < 50 )
                return notify_fail("你的内力不够，没有办法练段氏剑法。\n");


        if( (string)me->query_skill_mapped("force")!= "duan-force")
                return notify_fail("段氏剑法必须配合段氏心法才能练。\n");
...
int practice_skill(object me)
{
        ...
        ||      (int)me->query("force") < 3 )
                return 
notify_fail("你的内力或气不够，没有办法练习段氏剑法。\n");
