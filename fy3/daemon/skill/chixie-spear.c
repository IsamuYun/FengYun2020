...
mapping *action = ({
        ([      "action":               
"$N使一招「蝎点头」，手中$w一抖，化出无数枪头，直刺$n的$l",
                "dodge":                620,
                "parry":                500,
                "force" :               100,
                "damage_type":  "刺伤"
        ...
        ([      "action":               
"$N使出断魂枪中的「蝎天钩」，手中$w晃动，虚点数枪，突然自影中发出一枪，刺向$n的$l",
                "dodge":                620,
                "parry":                600,
                "force":               200,
                "damage_type":  "割伤"
...
"$N一招「蝎獒松」，向前猛窜，手中$w反背一枪，直扎$n的$l",
        ...
        ([      "action":               
"$N手中$w一式「蝎月扣」，手中$w枪头乱抖，铺天盖地杀来，枪枪不离$n的$l",
                "force":                90,
                "dodge":                230,
                "parry":                400,
                "damage_type":  "刺伤"
...
"$N的$w虚点，蓦地进步跟身，一招「蝎针刺」刺向$n的$l",
        ...
        ([      "action":               
"$N手中$w一递，枪身竟如残月般弯转，，一招「扑风蝎」反手对准$n$l一枪刺去",
...
int practice_skill(object me)
{
        ...
        ||      (int)me->query("force") < 3 )
                return 
notify_fail("你的内力或气不够，没有办法练习赤蝎枪法。\n");
