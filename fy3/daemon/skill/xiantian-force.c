...
mapping *action = ({
        ([      "action":
"$N使出一招「三重天地混元」，左手聚出一团先天真气击向$n的$l",
                "force":                800,
                "damage_type":  "瘀伤"
        ]),
        ([      "action":
"$N使出一招「五重天地混元」，右手聚出一团先天真气击向$n的$l",
                "force":                1200,
                "damage_type":  "瘀伤"
        ]),
	([ 	"action":
"$N使出一招「七重天地混元」，双手聚出一团先天真气击向$n的$l",
                "force":                1600,
                "damage_type":  "瘀伤"
        ]),
	([	"action":
"$N使出一招「九重天地混元」，全身腾空而起，全身化作一团先天真气击向$n的$l",
                "force":                3600,
                "damage_type":  "瘀伤"
        ]),
});
...
int practice_skill(object me)
{
    if ( (int)me->query("force") < 30 ) {
	    return notify_fail("你的内力或气不够，没有办法练习先天无极功。\n");
    }

	me->add("force", -30);

	write("你按著所学练了一遍先天无极功。\n");
