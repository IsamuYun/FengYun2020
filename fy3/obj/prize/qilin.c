...
void create()
{
    set_name(HIY "金麒麟" NOR, ({ "gold qilin", "qilin", "goose_money" }) );
	set("unit", "只");
	set("value", 0);
	set("long", HIC"一只金光闪闪、栩栩如生的金麒麟。\n
	你可以每天检查(checkqilin)一下它是否能下蛋。\n
...
int do_check(string arg)
{
    ...
    if( time()-query("last_check") < 60*15*4 )
        return notify_fail("金麒麟刚产过蛋不久,它需要休息。\n");
